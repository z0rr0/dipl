...
class Client(models.Model):
    ...
    email = models.EmailField(max_length=255, verbose_name=u'электронная почта', blank=True, null=True)
...
class Provider(models.Model):
    ...
    Поставщики
    """
    name = models.CharField(max_length=127, verbose_name=u'поставщик', db_index=True, help_text=u'название организации')
    phone = models.CharField(max_length=15, verbose_name=u'телефон')
    email = models.EmailField(max_length=255, verbose_name=u'электронная почта', blank=True, null=True)
    site = models.URLField(max_length=255, verbose_name=u'сайт', blank=True, null=True)
...
class Contract(models.Model):
    ...
    Сделка
    """
    product = models.ManyToManyField(Product, through='CRequest')
