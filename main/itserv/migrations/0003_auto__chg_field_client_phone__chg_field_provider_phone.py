...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('itserv_client', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Provider.phone'
        db.alter_column('itserv_provider', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))
    def backwards(self, orm):

        # Changing field 'Client.phone'
        db.alter_column('itserv_client', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Provider.phone'
        db.alter_column('itserv_provider', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15))
    models = {
        'auth.group': {
