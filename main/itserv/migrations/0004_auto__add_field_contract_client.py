...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contract.client'
        db.add_column('itserv_contract', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['itserv.Client']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Contract.client'
        db.delete_column('itserv_contract', 'client_id')
