...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reqlist.contract'
        db.alter_column('itserv_reqlist', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['itserv.Contract'], null=True, on_delete=models.SET_NULL))
    def backwards(self, orm):

        # Changing field 'Reqlist.contract'
        db.alter_column('itserv_reqlist', 'contract_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['itserv.Contract'], null=True))
    models = {
        'auth.group': {
        ...
        'itserv.contract': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 8, 0, 0)', 'db_index': 'True'}),
            'discont': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'itserv.reqlist': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['itserv.Client']"}),
            'contract': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['itserv.Contract']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
